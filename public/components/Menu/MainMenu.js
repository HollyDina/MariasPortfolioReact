  ...
  const data = [
    {
      ...
      content3: {
        ...
        textsection5: {
          ...
          headlineEng: "Collection of the interviews",
        ...
        textsection6: {
          ...
          headlineEng: "Purpose",
          textEng: "TextEng: In the final document, I transferred the interview responses to three needs maps: two for the children and one for the parents. The children’s maps focused on their interests and their needs.",
        ...
        textsection8: {
          ...
          headlineEng: "*Freestyle Parent*",
          textEng: "This parent tells the child to end screen time immediately and does not actively limit screen time, which often leads to conflict at the end. They are more resigned to the fact that there will be conflict when the child has to stop screen time.",
          
          
          headlineEng: "**Planner Parent**   ",
          textEng: "This parent actively limits screen time using tools like apps or alarms that warn the child when time is nearly up.",
          
          headlineEng: "Routine Parent",
          textEng: "This parent has set rules for when the child can use an iPad, TV, or computer and explains why screen time must end. They do not actively limit screen time, but the child follows routines that act as benchmarks, such as watching until dinner is ready or brushing teeth. The Routine Parent warns the child when screen time is nearly over and allows them to finish depending on how much time is left in the show or game.",
          
          headlineEng: "Differences in Child Behavior Types*",
          textEng: "Children’s behavior types vary based on their interest in iPads, TV, or computers, which is influenced by the number of other activities they have. When the child engages in other activities, they tend to forget about the iPad. Another difference is how much freedom the child has to decide for themselves.",
