      ...
      <div className="hero-content">
        <div className="hero-text-content">
          ...
          <div className="hero-social-content">
            <a style={{maxHeight:"50px"}} href="https://www.linkedin.com/in/maria-ekman-187287b0/">
            ...
            <a style={{maxHeight:"50px"}} href="https://github.com/mariaekmaan1991"><svg className="hero-social-icon" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512">
