  ...
  const data1= [{
    ...
    content1: {
      ...
      intro: {
        ...
        headlineEng: "Role",
        textEng: "Servicedesigner\nUser Research",
        headlineIntroSwe: "Verktyg & Metoder",
        textIntroSwe:
          "Business model canvas\nJob to be done\nBehovsanalys\nResearch\nKundresekarta\nBehövas Hypotes",
        headlineMainEng: "Chas academy",
        headlineIntroEng: "TOOL",
        textIntroEng:
          "Job to be done\nTrello\nBusiness model canva\nCustomer journey map\ngmail, google meeting",
        images: "",
      ...
      textsection1: {
        ...
        headlineSwe: "Syfte",
        textSwe:
          "Syftet med denna analys är att identifiera och förbättra kundresan för studenter inom UX-design på CHAS Academy, med målet att öka studenternas tillfredsställelse och samtidigt stärka akademins affärsutveckling. Detta innebär att identifiera utbildningens nuvarande styrkor och svagheter för att utforska hur vi kan förbättra kvaliteten på utbildningen och göra den mer attraktiv för potentiella studenter, samt stå starkare i konkurrensen med liknande utbildningar.\n\nGenom att beakta studenternas behov och förväntningar kan CHAS Academy anpassa sin utbildning för att hjälpa studenter att bli aktiva på arbetsmarknaden och skapa en stark koppling mellan utbildningens innehåll och arbetsmarknadens behov.",
        headlineEng: "The purpose",
        textEng:
          "The purpose of this analysis is to identify and improve the customer journey for students in UX design at CHAS Academy, with the aim of increasing student satisfaction while also strengthening the academy’s business development. This involves identifying the current strengths and weaknesses of the program to explore how we can enhance the quality of the education, making it more attractive to potential students, and standing stronger against competition from similar programs.\n\nBy considering students’ needs and expectations, CHAS Academy can adapt its curriculum to help students become active in the job market and create a strong connection between the program content and the demands of the workforce.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images"
      },
      textsection2: {
        ...
        headlineEng: "Goal",
        textEng:
          "Improve the areas that have the greatest impact on customer satisfaction and business goals.\n- Increase market share within UX education.\n- Improve the customer experience and business model.\n- Strengthen CHAS Academy's brand to attract more students.\n- Increase the number of applicants for the program.\n- Expand in the UX field and increase the number of students by 30% within 1-3 years.\n- Enhance the quality of education.\n- Create a more attractive educational experience that effectively meets students' needs and expectations.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images"
      },
      textsection3: {
        ...
        textSwe:
          "Kundrese-kartan visar de olika faserna i kundresan, som börjar med att man upptäcker UX och finner det intressant. Nästa steg är att undersöka och forska för att hitta rätt skola, följt av ansökan och antagning, innan man påbörjar utbildningen.\n\nFasen 'går i skolan' delas upp i tre underkategorier: “Innehåll och kurser”, “lärare” samt “kommunikation och socialt”, vilket är viktigt att förstå separat. Dessa faser pågår parallellt, vilket illustreras med en cirkulär pil. Nästa fas praktiken och därefter examinationen, vilket förhoppningsvis leder till ett jobb.\n\nI den vänstra kolumnen finns rubriker som beskriver interaktioner, mål, touchpoints (illustrerade med ikoner) samt positiva och negativa tankar från intervjudeltagare. Jag har också skapat en känslokurva som visar vilka faser som varit positiva och vilka som varit mindre bra, avslutat med insikter och möjligheter.",
        headlineEng: "Customer journey map",
        textEng:
          "The customer journey map illustrates the different phases of the customer journey, starting with discovering UX and finding it interesting. The next step is researching and investigating to find the right school, followed by the application and admission process, before starting the program.\n\nThe phase 'attending school' is divided into three subcategories: 'Content and courses,' 'Teachers,' and 'Communication and social aspects,' which are important to understand separately. These phases run concurrently, represented by a circular arrow. The next phase is the internship, followed by graduation, which will hopefully lead to a job.\n\nIn the left column, there are headings that describe interactions, goals, touchpoints (illustrated with icons), as well as positive and negative thoughts from the interview participants. I have also created an emotional curve showing which phases were positive and which were less so, concluding with insights and opportunities.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images"
      },
      textsection4: {
        ...
        textSwe:
          "Studerande-upplevelser innefattar olika 'pain points' och 'moments of truth' under kundresan. Citat från eleverna visar hur de känner:\nI undersökningsfasen uttryckte många att de gillade blandningen av UX och krav, samt att skolan grundades av Chas Visual Management.\n\nEleverna tyckte att Chas kändes modernt med en personlig touch och valde YH för den praktiska lärandeformen: “Jag vill gå en praktisk utbildning så jag kan lära mig på riktigt”.\n\nTidigt i resan hade studenterna högre förväntningar på skolans struktur, vilket framgick av att ordet 'rörigt' ofta nämndes i varje fas, vilket de gula stjärnorna visar. I 'börja skolan-fasen' kände de att personalen inte var helt förberedd.\n\nUnder 'innehåll-och-kurser'-fasen upplevde vissa att förväntningarna inte höll måttet: “För mycket fokus på kravhantering” och “Jag vill lära mig Figma/UI bättre än skolan erbjuder”. Andra klagade på otydliga uppgifter och bristande återkoppling från skolans personal.\n\nI praktikfasen noterade studenterna att skolan saknade ett branschnära nätverk för praktikplatser: “Varför använder inte skolan sitt nätverk för att hjälpa oss?”.\n\nSlutligen i 'examinations-fasen' uttryckte eleverna frustration över dålig kommunikation kring arbeten och resultat av examinationerna. De upplevde också att skolan gav mycket eget ansvar, vilket inte alla tyckte var positivt. Sammanfattningsvis visade intervjuerna att eleverna kände sig frustrerade över otydligheter i utbildningen och bristen på kommunikation från skolan.",
        headlineEng: "Pain points & Moments of truth",
        textEng:
          "Student experiences include various pain points and moments of truth during the customer journey. Quotes from students express how they feel:\nIn the research phase, many expressed liking the blend of UX and requirements, as well as that the school was founded by Chas Visual Management.\n\nStudents felt that Chas seemed modern with a personal touch and chose YH for the practical learning format: 'I want to attend a practical program so I can learn for real.'\n\nEarly in the journey, students had higher expectations of the school's structure, as indicated by the word 'chaotic' often mentioned in each phase, as shown by the yellow stars. In the 'starting school phase,' they felt that the staff was not fully prepared.\n\nDuring the 'content and courses phase,' some experienced unmet expectations: 'Too much focus on requirements management' and 'I want to learn Figma/UI better than what the school offers.' Others complained about unclear assignments and lack of feedback from the school's staff.\n\nIn the internship phase, students noted that the school lacked an industry-relevant network for internships: 'Why doesn’t the school use its network to help us?'\n\nFinally, in the 'graduation phase,' students expressed frustration over poor communication regarding assignments and results of the examinations. They also felt that the school placed a lot of responsibility on them, which not everyone viewed positively. In summary, the interviews showed that students felt frustrated by ambiguities in the program and a lack of communication from the school.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images"
      },
    ...
    content2: {
      id: 2,
      intro: {
        headlineMainSwe: "Företagssidan",
        textSwe: "Tjänster designer\nAnvändartester",
        headlineMainEng: "The company page",
      ...
      textsection5: {
        ...
        textEng:
          "Corporate users had difficulty identifying which page they were on and which they had previously visited. They encountered challenges in completing tasks due to excessive and overwhelming text, as well as unexpected information appearing on the wrong pages. At the same time, the website received positive feedback for its professional appearance and the inviting imagess of people.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      },
    ...
    content4: {
      ...
      textsection1: {
        ...
        headlineMainEng: "Uppsala Soup Kitchen",
...
/*
  const data2 = [{
    content2: {
      ...
      textsection7: {
        ...
        textSwe:
          "Här är min uppfattning av Chas Academys nuvarande affärsmodell på UX-området, det innehåller en del brister. Här är förbättringsmöjligheter och var i affärsmodellen de har en inverkan.",
        headlineEng: "Chas Academy’s current business model in the UX-field",
        textEng: "My perception of Chas Academy's current business model in the UX-field contains some flaws. Here are some opportunities for improvement and where in the business model they have an impact.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      },
      ...
      textsection9: {
        ...
        textSwe:
          "Det fanns missförstånd kring fördelningen av UX-design och krav. Jag föreslår att vi klargör utbildningens namn, som “UX-designer och Kravhanterare” , för att ändra studenternas “Jobs to be done”. ",
        headlineEng: "The mix of UX design and requirements",
        textEng: "There were misunderstandings regarding the distribution of UX design and requirements. I suggest clarifying the program's name as “UX Designer and Requirements Manager” to change the students “Jobs to be done.”",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      },
      textsection10: {
        ...
        textSwe:
          "Trots att Chas Academy är skapad av ett branschbolag utnyttjas dess potential inte fullt ut.En möjlighet är att använda kontakter från Chas Visual Management och ledningsgruppen. Eleverna kan till exempel lösa verkliga case från Chas Visual Management, vilket är viktigt för deras erfarenhet och framtida portfolio.Chas Visual Management kan även erbjuda praktikplatser och eventuellt anställningar efter utbildningen. De och deras kunder kan också fungera som en kanal för att promota skolan på sina hemsidor.",
        headlineEng: "Industry-related",
        textEng: " Despite being created by an industry company, Chas Academy's potential is not fully utilized. One opportunity is to leverage contacts from Chas Visual Management and the management team. Students could, for example, work on real cases from Chas Visual Management, which is important for their experience and future portfolios.Chas Visual Management can also offer internships and potentially employment after graduation. They and their clients could serve as a channel to promote the school on their websites.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      },
      textsection11: {
        ...
        textSwe:
          "Många studenter förväntade sig en mer praktisk utbildning än vad som erbjöds. För att uppfylla värdeerbjudandet om praktisk utbildning kan ni skapa en övningsbank för studenterna. Samarbeten med utvecklarna i klassen kan ge erfarenhet av teamarbete, och frekventa Figma-lektioner kan vara fördelaktiga. Utökat samarbete med partners kan också bidra till lärorika och verklighetsanknutna övningar och föreläsningar för att förstå hur metoder och teorier tillämpas i praktiken.",
        headlineEng: "Practical training",
        textEng: "Many students expected a more practical education than what was offered. To fulfill the value proposition of practical training, you can create a bank of exercises for the students. Collaborations with developers in the class can provide experience in teamwork, and frequent Figma lessons could be beneficial. Increased collaboration with partners can also contribute to educational and real-world relevant exercises and lectures to understand how methods and theories are applied in practice.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      },
      textsection12: {
        ...
        headlineEng: "Improvement area",
        textEng: "The final area for improvement concerns the scenario where students fail to complete their work, which may be due to experiencing an unstructured environment at the school. To meet students' goals of learning UX, lessons should be clear. External teachers can undergo an onboarding process to reduce misunderstandings and technical issues. Creating a portfolio is an important part of UX learning, and it would be beneficial to implement “portfolio days” after major submissions to facilitate the process leading up to internships and job searching. To improve the relationship with students, feedback and proactive engagement should be prioritized. Investing more in staff and teachers can ensure that assignments are clear before they are distributed and enhance the pedagogy in teaching.In addition to these four areas, social media can be utilized for targeted marketing, the possibility of a one-year program or individual courses can be considered, and former students can be encouraged to leave reviews online. The principal should also request regular staff evaluations to encourage honest feedback. Finally, expectations regarding students' behavior during lessons, such as using cameras and asking questions, should be clarified at the beginning of the program.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      },
      textsection13: {
        headlineSwe: "",
        textSwe:
          " “pain points” och “moments of truth” ",
        headlineEng: "",
        textEng: "",
        images: "",
        altSwe: "Beskrivning på bilden",
    ...
    content2: {
      ...
      textsection1: {
        headlineSwe: "Research",
        textSwe: "Jag fick i uppdrag av Loopeli att förbättra strukturen på deras webbplats för att göra den mer användarvänlig för företagsanvändare. Målet var att underlätta för dem att snabbt hitta relevant information och fatta beslut om att integrera Loopeli i sin verksamhet. Genom att analysera hur företag söker efter välfärds-hjälpmedel och användarnas feedback på appen identifierade jag förbättringsmöjligheter. Dessa insikter användes för att förbättra användarupplevelsen och göra det lättare för företag att köpa och använda Loopeli.",
      ...
      textsection2: {
        headlineSwe: "Användartesterna",
        textSwe:
          "Jag beslutade mig för att tillämpa “tänka högt”-metoden på menyn för att observera användarnas förväntningar. Det blev tydligt att meny-namnen var vagt formulerade och kunde tolkas på många olika sätt.Jag formulerade två frågor som riktlinjer för användartester och intervjuer för att säkerställa tydlig inriktning och undvika avvikelser från det centrala ämnet.",
          textSwe: ":Fråga 1: Vad vill jag veta från användartesterna och intervjuerna? Fråga 2: Vad vill jag uppnå med användar-testerna och intervjuerna? Svar 1:** Vilken information behöver användarna för att besluta om att implementera produkten? Finns den tillgänglig, eller saknas viktig information? Vi vill observera hur användarna navigerar på olika sidor för att söka information om Loopeli. Svar 2:** Hur kan vi förbättra användarnas möjlighet att hitta information på webbplatsen? Kan vi underlätta snabbare beslut om produktens implementering i deras verksamhet? Innan intervjuerna genomförde jag en testintervju för att se om förändringar behövde göras i frågorna. Deltagaren hade svårt att tänka sig in i case-scenarion, så jag justerade frågorna. Frågan ´Vilken typ av information behöver användarna för att besluta om att implementera produkten?´ ändrades till´Vilka egenskaper ska produkten ha för att passa er verksamhet och målgrupp?´ och ´Vad behöver du för information för att köpa in produkten?´ Användarna fick sedan leta efter egenskaperna på webbplatsen, men hade svårt att komma ihåg dem, så svaren skrevs ner. Frågorna visade sig vara avgörande för att förstå vad användarna söker och om informationen på webbplatsen var tillräcklig, även om de tog längre tid att genomföra.",
        headlineEng: "",
        textEng: "",
        images: "",
        altSwe: "Beskrivning på bilden",
        ...
        textEng: "All interviews were documented and compiled into a file, which was transferred to a table in Miro. It was clarified which participants succeeded in their tasks and which did not. I grouped similar notes, removed duplicates, and compiled everything into a needs map to visualize the results and created personas. The results were then presented to the product owner.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      ...
      textsection4: {
        ...
        textEng: ":I started by reviewing the website using Miro to identify potential issues and create hypotheses about any shortcomings, such as interface and navigation challenges. I also aimed to gain an overview of the website's current structure. After that, I contacted support to discuss the problems users have encountered",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      ...
      textsection6: {
        headlineSwe: "Collection of Insights and Proposed Solutions",
        textSwe:
    ...
    content5: {
      ...
      textsection2: {
        headlineSwe: "Hypotes",
        textSwe: "Jag antog att användarna hade svårt att förstå rumknappens funktion. För att Artportable ska kunna öka försäljningen på sin webbplats bör de överväga en redesign som uppmuntrar till fler köp.",
        headlineEng: "Hypotes",
        textEng: "I assumed that users had difficulty understanding the function of the room button. To help Artportable increase sales on its website, they should consider a redesign that encourages more purchases.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      }, 
    ...
    content6: {
      id: 3,
      intro: {
        headlineMainSwe: "Examens arbete",
        textSwe: "Projektledare ",
        headlineEng: "Uppsala soup kitchen",
        textEng: "Service designer\nUser Research",
        headlineIntroSwe: "Verktyg & Metoder",
      ...
      textsection8: {
        headlineSwe: "Här är några av de viktigaste behoven som överfördes till prototypen",
        textSwe:
      ...
      textsection11: {
        ...
        textEng: " I used red in the interface because the color draws attention and increases click rates. After reading about how colors influence behavior, I also chose gender-neutral colors for the hi-fi prototype to appeal to everyone.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      ...
      textsection13: {
        ...
        textEng: "I started with low-fi sketches and moved on to hi-fi prototypes to test children's reactions to colors and movement. It’s hard for children to imagine apps on paper during user tests, so I made real-time adjustments to the prototype. During the tests, I discovered that several children had never used a computer before, which made the tests difficult and intimidating for them. Due to technical issues, I couldn’t conduct more tests. In total, 5 user tests were conducted with children (ages 3-9) and 8 with adults, as parents were more familiar with using computers.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      ...
      textsection14: {
        ...
        textEng: "I have completed what I planned and am satisfied with the result and my work. There are only hi-fi prototypes for desktop, not mobile, due to time constraints. The app lacked sound, so I replaced it with text and speech bubbles. I'm not completely satisfied with the menu, as users found it difficult to navigate. The next step is to improve the menu and design the final views. The project has taken time, and in hindsight, a smaller project would have been easier to manage on my own.",
        images: "",
        altSwe: "Beskrivning på bilden",
        altEng: "Description of the images",
      ...
      content1: {
        id: 1,
          intro: {
            ...
            textToolsSwe: "Miro",
            textToolsSwe: "Personas",
            textToolsSwe: "Kvalitativ metod",
            textToolsSwe: "Behovskarta",
            textToolsSwe: "Affinity Diagramming",
            headlineToolsEng: "Tools & Methods",
            textToolsEng: "Miro",
            textToolsEng: "Personas",
            textToolsEng: "Qualitative method",
            textToolsEng: "Behovskarta",
            textToolsEng: "Affinity Diagramming",
            images: "",
            altSwe: "Beskrivning på bilden",
            altEng: "Description of the images",
        ...
        textsection1: {
         ...
         textsection1: {
          ...
          headlineEng: "Assignment on the Loopeli company",
          textEng: "För att utforska användarnas tankar och beteenden använde jag semistrukturerade intervjuer och användartester. Denna metod gav en djupare förståelse för deras behov och bekräftade mina hypoteser från utvärderingen, samt identifierade ytterligare förbättringsområden för webbplatsen.",
          images: "",
          altSwe: "Beskrivning på bilden",
          altEng: "Description of the images",
        },
        ...
        textsection2: {
          ...
          textSwe:
            ":Fråga 1: Vad vill jag veta från användartesterna och intervjuerna? Fråga 2: Vad vill jag uppnå med användar-testerna och intervjuerna? Svar 1:** Vilken information behöver användarna för att besluta om att implementera produkten? Finns den tillgänglig, eller saknas viktig information? Vi vill observera hur användarna navigerar på olika sidor för att söka information om Loopeli. Svar 2:** Hur kan vi förbättra användarnas möjlighet att hitta information på webbplatsen? Kan vi underlätta snabbare beslut om produktens implementering i deras verksamhet? Innan intervjuerna genomförde jag en testintervju för att se om förändringar behövde göras i frågorna. Deltagaren hade svårt att tänka sig in i case-scenarion, så jag justerade frågorna. Frågan ´Vilken typ av information behöver användarna för att besluta om att implementera produkten?´ ändrades till´Vilka egenskaper ska produkten ha för att passa er verksamhet och målgrupp?´ och ´Vad behöver du för information för att köpa in produkten?´ Användarna fick sedan leta efter egenskaperna på webbplatsen, men hade svårt att komma ihåg dem, så svaren skrevs ner. Frågorna visade sig vara avgörande för att förstå vad användarna söker och om informationen på webbplatsen var tillräcklig, även om de tog längre tid att genomföra.",
          headlineEng: "User Testing",
          textEng:"I decided to apply the 'think aloud' method on the menu to observe users' expectations. It quickly became evident that the menu names were vaguely formulated and could be interpreted in several ways.  I developed two questions as guidelines for user tests and interviews to ensure a clear focus and avoid deviations from the central topic.  TextEng: Question 1: What do I want to know from the user tests and interviews?Question 2: What do I aim to achieve with the user tests and interviews? Answer 1: What information do users need to decide on implementing the product? Is it available, or is essential information missing? We want to observe how users navigate various pages to seek information about Loopeli. Answer 2: How can we improve users' ability to find information on the website? Can we facilitate quicker decisions regarding product implementation in their operations? Before the interviews, I conducted a test interview to see if any adjustments were needed in the questions. The participant had difficulty imagining themselves in case scenarios, so I modified the questions. The question `What type of information do users need to decide on implementing the product?´was changed to `What features should the product have to fit your business and target audience?´ and `What information do you need to consider purchasing the product?´Users were then asked to look for the features on the website but found it challenging to remember them, so their answers were recorded. The questions proved essential to understanding what users are searching for and whether the information on the website was sufficient, even though the process took more time to conduct.",
          images: "",
          altSwe: "Beskrivning på bilden",
          altEng: "Description of the images",
        },
        ...
        textsection6: {
          headlineSwe: "",
          textSwe: " “pain points” och “moments of truth” ",
          headlineEng: "",
          textEng: "",
          images: "",
          altSwe: "Beskrivning på bilden",
      ...
      content4: {
        id: 4,
          intro: {
            ...
            headlineToolsSwe: "Verktyg & Metoder",
            textToolsSwe: "Business model canvas",
            textToolsSwe: "Job to be done",
            textToolsSwe: "Behovsanalys",
            textToolsSwe: "Kundresekarta",
            HealineToolsEng: "Tools & Methods",  
            textToolsEng: "Business model canva",
            textToolsEng: "Job to be done",
            textToolsEng: "Needs analysis",
            textToolsEng: "Customer journey map",
            images: "",
            altSwe: "Beskrivning på bilden",
            altEng: "Description of the images",
          },
        ...
        id: 5,
          intro: {
            ...
            textToolsSwe: "Behovskarta",
            textToolsSwe: "Affinity Diagramming",
            textToolsSwe: "Använadare tester",
            headlineToolsEng: "Tools & Methods",
            textToolsEng: "Miro",
            textToolsEng: "Personas",
            textToolsEng: "Qualitative method",
        ...
        intro: {
          headlineMainSwe: "Soppkök Uppsala",
          roleSwe: "Projektledare ",
          headlinMainEng:"Uppsala soup kitchen",
          roleEng:"Project manager",
          toolsSwe: "Verktyg & Metoder",
          textToolsSwe: "Planering",
          textToolsSwe:"Värva företag ",
          toolsEng: "Tools & Methods",
          textToolsEng: "Planning",
          textToolsEng: "Recruit companies",
          images: "",
          altSwe: "Beskrivning på bilden",
          altEng: "Description of the images",
      },
  ...
  const dataHome = [
    ...
    },
    {
      ...
      descriptionSwe: "Jag fick i uppdrag av Loopeli att förbättra strukturen på deras företagssida för att göra den mer användarvänlig för företagsanvändare och underlätta deras beslut att integrera Loopeli. Genom en UX-review identifierade jag gränssnittsproblem och användarnas behov genom intervjuer och test.",
      headlineMainEng: "Loopeli's Company Page",
      descriptionEng: "I was tasked by Loopeli to improve the structure of their company page to make it more user-friendly for corporate users and facilitate their decision to integrate Loopeli. Through a UX review, I identified interface issues and user needs through interviews and testing.",
      headlineIntroSwe: "Verktyg & Metoder",
      images: "Frame_1944.png",
      altSwe: "Beskrivning på bilden",
      altEng: "Description of the images",
    },
    {
      ...
      descriptionSwe: "Projektet syftar till att minska behovet av supportsamtal genom att identifiera hinder i Loopelis privatsida och analysera användarnas navigering. Genom att justera innehåll och design ska man bättre möta målgruppens behov och underlätta för dem att skaffa Loopeli-appen. Användartester har genomförts för att samla insikter om användarbeteenden och skapa personas, vilket hjälper till att anpassa webbplatsens struktur för att förbättra användarupplevelsen.",
      headlineMainEng: "Loopeli's Private Page",
      descriptionEng: "The project aims to reduce the need for support calls by identifying obstacles on Loopeli's private page and analyzing user navigation. By adjusting content and design, it seeks to better meet the needs of the target audience and facilitate their acquisition of the Loopeli app. User tests have been conducted to gather insights into user behaviors and create personas, which helps tailor the website's structure to improve the user experience.",
      headlineIntroSwe: "Verktyg & Metoder",
      images: "Frame_1944.png",
      altSwe: "Beskrivning på bilden",
      altEng: "Description of the images",
